...
Deploying to Cloudflare requires the [OpenNext](https://opennext.js.org/cloudflare/get-started) adapter and Cloudflare's wrangler (can be installed globally). Take note of the configuration files and bindings in order to deploy to a Cloudflare Worker
